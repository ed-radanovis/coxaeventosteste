...
export function CertificationsGrid() {
  ...
  const handleItemTap = (index: number) => {
    setTappedItem(index);
    setTimeout(() => setTappedItem(null), 700);
  };
  ...
  return (
    ...
    >
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="flex justify-center">
          <motion.div
            className="inline-flex gap-5 md:grid md:grid-cols-5 md:gap-28"
            ...
            {certifications.map((cert, index) => (
              ...
              >
                <motion.div
                  ...
                  className={`rounded-sm border border-stone-900 transition-all duration-300 ${
                    !mounted
                  ...
                  } ${tappedItem === index ? "scale-105 shadow-lg" : ""}`}
                >
                  {/* internal container */}
                  <div
                    className={`group flex h-12 w-12 items-center justify-center rounded-sm transition-all duration-300 md:h-24 md:w-24 ${
                      !mounted
                        ...
                        : theme === "dark"
                          ? "bg-stone-200"
                          : "bg-stone-400"
                    } ${tappedItem === index ? "brightness-110" : ""}`}
                  >
                    <Image
                      src={cert.image}
                      alt={cert.alt}
